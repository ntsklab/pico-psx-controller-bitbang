...
- **通常プレイ**: `BUTTON_LATCHING_MODE 0`, `DEBUG_ENABLED 0`
- **格闘ゲーム**: `BUTTON_LATCHING_MODE 1`, `DEBUG_ENABLED 0`（短い入力も確実に検出）
- **開発/デバッグ**: `DEBUG_ENABLED 1`（統計情報でタイミング確認）
